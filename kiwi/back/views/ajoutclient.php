    ...
    <div id="right-panel" class="right-panel">
        ...
        <!-- Header-->
                                                    ...
                                                    <div class="card-header">
                                                        <strong> Gestion des Clients</strong> Détails
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="clientf">
...
<div>
																								<h2><a href="imprimerlisteclient.php">Imprimer Liste clients</a></h2>
                                                <h2><a href="envoyerMail.php">Envoyer Mail</a></h2>
<?php }?>
</div>
